...
<header>
  ...
  <div class="relative inline-block">
    <div class="absolute top-0 left-0 rounded-full -translate-y-1/3 -translate-x-1/2 border-2 border-primary bg-white text-primary px-2 py-[2px] text-xs z-10">
      Free trial
    </div>
    <Button @click="process" class="px-5 py-2.5">
      Login or Register
    </Button>
  </div>
